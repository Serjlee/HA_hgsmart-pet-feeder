...
### Can you support more models?

Probably, since the API looks generic enough to work with more models with little to no changes. Let me know you'd like to help me add support for more models.
